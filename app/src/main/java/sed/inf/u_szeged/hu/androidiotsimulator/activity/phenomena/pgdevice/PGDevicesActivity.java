...
import sed.inf.u_szeged.hu.androidiotsimulator.activity.phenomena.population.PopulationSettingsActivity;
...
public class PGDevicesActivity extends AppCompatActivity {
    ...
    private void createNewPGDevice() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PGDevicesActivity.this);
        ...
        PGDeviceSelectTypeAdapter adp = new PGDeviceSelectTypeAdapter(PGDevicesActivity.this,
                R.layout.listitem_pgdevice_newdevice_type, availableTypes);

        final Spinner sp = new Spinner(PGDevicesActivity.this);
        ...
        builder.setPositiveButton(R.string.ok_btn, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(PGDevicesActivity.this, PGDeviceSettingsActivity.class);
                Bundle bundle = new Bundle();
